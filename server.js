...
app.post("/api/add-event", isLoggedIn, async (req, res) => {
  ...
  const newReminder = new Reminder({
    ...
    eventTime,
    reminderType,
    isRecurringEvent: isRecurringEvent || eventType === "birthday" || eventType === "anniversary",
    recurringFrequency: recurringFrequency || (eventType === "birthday" || eventType === "anniversary" ? "yearly" : null),
    notes,
    user: req.user._id,
    lastSent: undefined,
  });
